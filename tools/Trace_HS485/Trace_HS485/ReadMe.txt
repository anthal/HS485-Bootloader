========================================================================
    ANWENDUNG: Trace_HS485-Projektübersicht
========================================================================

Diese Trace_HS485-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Trace_HS485-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Trace_HS485.pch und eine 
